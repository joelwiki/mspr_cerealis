...
public abstract class CameraActivity extends AppCompatActivity
  ...
  private static final String PERMISSION_READ_EXTERNAL = Manifest.permission.READ_EXTERNAL_STORAGE;
  ...
  private void requestPermission() {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
      ...
      requestPermissions(new String[] {PERMISSION_CAMERA,PERMISSION_WRITE_EXTERNAL,PERMISSION_READ_EXTERNAL}, PERMISSIONS_REQUEST);
    }
  }
  ...
  protected  boolean getDrawingHaveBeenDrawing(){
    return this.drawingHaveBeenDetermined;
  }

  protected void readyForNextImage() {
    if (postInferenceCallback != null && !drawingHaveBeenDetermined ) {
  ...
  protected abstract boolean getImageSaved();
